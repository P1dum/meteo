...
PORTB = PORTB & 0b11011111;
  Serial.print("/");
  Serial.print(Pres_and_Temp1.Temperature); // send a byte
  Serial.print("/");
  Serial.print(getLux()); // send a byte
  Serial.print("/");
  Serial.print(Pres_and_Temp1.Pressure); // send a byte
  Serial.print("\n");
